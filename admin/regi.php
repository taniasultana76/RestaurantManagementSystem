     ...
     <ul class="sidebar navbar-nav">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <hr>
          <p>Who and how many customers are registered</p>
        ...
        <table class="table table-hover table-light table-striped" id="table-data">
          ...
          <tbody>
            ...
            <td><?= $row['address']; ?></td>
            <td><?= $row['gen']; ?></td>
            <td><img src="images/<?= $row["img"]; ?>" style="width: 52px;height: 50px"></td>
            <td><a href="deletereg.php?id=<?php echo $row['id'];?>"class=" badge badge-danger">Delete</a></td>
            </tr>
            <?php } ?>
