    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <h1>Inside Order-Detailes Management</h1>
          <hr>
         <div class="container-fluid">

             <?php $sql1 ="SELECT * FROM tbl_order WHERE status='Waiting'";
             ...
             <?php $sql2 ="SELECT * FROM tbl_order WHERE status='Completed'";
             ...
             <?php $sql3 ="SELECT * FROM tbl_order WHERE status='cancelled'";
            ...
            <div class="card-body">
              <table id="tblCurrentOrder" class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody id="tblBodyCurrentOrder">
                      <?php 
                      $displayOrderQuery =  "
                        SELECT o.orderID,OD.username, m.menuName, OD.itemID,MI.menuItemName,OD.quantity,O.status,mi.price ,o.order_date,o.chef
                        FROM tbl_order O
                        ...
                        if ($orderResult->num_rows == 0) {
                          ...
                          while($orderRow = $orderResult->fetch_array(MYSQLI_ASSOC)) {
                            ...
                            if ($currentspan == $rowspan) {
                              ...
                              echo "<td rowspan=".$rowspan." class='text-center'>".$orderRow['chef']."</td>";
