...
<ul class="sidebar navbar-nav">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <h1>Online Sales Management</h1>
          <hr>
          <p>All  online sales data here.</p>
            ...
            <div class="card-body">
              <table class="table table-bordered" width="100%" cellspacing="0">
                <tbody>
                  <tr>
                    <td>Today</td>
                    <td>Tk <?php echo getOnlineSalesGrandTotal("DAY"); ?></td>
                  </tr>
                  <tr>
                    <td>This Week</td>
                    <td>Tk <?php echo getOnlineSalesGrandTotal("WEEK"); ?></td>
                  </tr>
                  <tr>
                    <td>This Month</td>
                    <td>Tk <?php echo getOnlineSalesGrandTotal("MONTH"); ?></td>
                  </tr>
                  <tr class="table-info">
                    
                    <td><b>Grand-Total</b></td>
                    <td><b>Tk<?php echo getOnlineSalesGrandTotal("ALLTIME"); ?></b></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-chart-area"></i>
              Check Profit Statistics of Online Sales
          </div>
    ...
    <div class="table-responsive">
      <table class="table table-bodered" id="order_data" >
        ...
        <tfoot >
          <th  colspan="7" style="text-align: ">Grand Total:</th>
