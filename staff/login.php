...
<html lang="en">
  ...
  <body style="background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(../image/Picture6.jpg);height:100vh;
...
<div class="col-md-6 my-3" style="width: 500px;
    ...
    margin-top: 160px;"><br/><br/>
        <div class="card text-uppercase">
          <h1 class="text-uppercase" style="font-family:'copper';text-align: center"><b>Staff Log-in</b></h1>
        </div>
