  ...
  <head>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <?php $sql ="SELECT * FROM tbl_online_order WHERE status='waiting'";
              $res = mysqli_query($sqlconnection, $sql);
             $count = mysqli_num_rows($res);

             
                ?>
             <li class=" active"><font style="margin-left: 700px;"><i class="fas fa-concierge-bell"></i>&nbsp;Current-Order:&nbsp;<font style="color:red"><b><?php echo $count; ?></b></font></font></li>
          </ol>
          ...
          <thead>     
                     ...
                     <th>Customer-name</th>
                      ...
                      <th style="width: 12%">Food-name</th>
                      <th>Qty</th>
                      <th>Price</th>
                      <th>Total</th>
    ...
    <script type="text/javascript">
        ...
        function refreshTableOrder() {
         $( "#tblBodyCurrentOrder" ).load( "on_displayorder.php?cmd=currentorder1" );
            }
