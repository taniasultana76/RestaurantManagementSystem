    ...
    <section class="food-menu">
        <div class="container">
            ...
            $db= 'fosdb';
               ...
               $con = mysqli_connect($server,$user,$password,$db);
                $sql = "SELECT * FROM tbl_menuitem WHERE menuItemName Like '%$search%' OR price Like '%$search%'";
       ...
       <div class="food-menu-box" style="height: 50px;margin-left: 26%"><strong style="margin-left: 17%">Sorry!This item are not available right now</strong></div>';
            <?php
       }
       ?>
